"""
Neuron Intervention Experiment - Correct Four Module Structure (Pythia-160M)
...
# ==================== Model Manager - Fixed Intervention ====================
class ModelManager:
    """Manage local Pythia-160M model with working intervention"""
    ...
    def _load_model(self):
        """Load local model"""
        print("=" * 60)
        print("🚀 Loading Pythia-160M from LOCAL path")
        print("=" * 60)
        ...
        with gr.Column():
            ...
            with gr.Row():
                with gr.Column(scale=1):
                    gr.Markdown(
                        f"**Model:** Pythia-160M | **Layers:** 0-{self.n_layers - 1} | **Neurons/layer:** {self.d_mlp}")
...
class ComparisonModule:
    ...
    def create_ui(self):
        ...
        with gr.Column():
            ...
            with gr.Row():
                # Removed refresh button as File components don't need it
...
class NeuronInterventionApp:
    """Main application - Four module structure with working intervention"""

    def __init__(self, model_path: str):
        print("\n" + "=" * 60)
        print("🧠 NEURON INTERVENTION EXPERIMENT SYSTEM")
        print("=" * 60)
    ...
    def create_interface(self):
        ...
        with gr.Blocks(title="🧠 Neuron Intervention System", theme=gr.themes.Soft()) as app:
            gr.Markdown("# 🧠 Neuron Intervention Experiment System")
            gr.Markdown("### Four-Module Structure: Monitor → Intervene → Generate → Compare")
            gr.Markdown("### ✅ Intervention Fixed: Now uses tensor cloning to ensure neurons are set to zero")
            ...
            # Initialize - no need for file list initialization anymore
            app.load(
                fn=clear_inhibit,
                outputs=[intervention_ui["inhibit_list"], inhibit_df_state,
                         intervention_ui["inhibit_count"], inhibit_text_state]
...
def main():
    ...
    try:
        ...
        print("📁 Fingerprints saved to: ./fingerprints/")
        print("\n" + "=" * 60)
